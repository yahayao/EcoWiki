...
└── 📁 src/                                   # 源代码目录
    ...
    │   ├── 📁 admin/                         # 管理后台组件
    │   │   ├── AdminDashboard.vue           # 管理后台主仪表板
    │   │   ├── AdminUserList.vue            # 管理员用户列表
    │   │   └── 📁 views/                    # 管理后台页面组件
